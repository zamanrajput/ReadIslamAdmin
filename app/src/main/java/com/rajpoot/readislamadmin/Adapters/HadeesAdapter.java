...
public class HadeesAdapter extends RecyclerView.Adapter<HadeesAdapter.Holder> {

    ArrayList<HadeesModel> list;

    public HadeesAdapter(ArrayList<HadeesModel> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        HadeesModel model = list.get(position);
        holder.delBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(holder.delBtn.getContext())
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                db.collection("Hadeesat").whereEqualTo("titleUrdu",tempUT)
                ...
                }).setMessage("Are you to delete Hadees "+temNE+"?").show();
